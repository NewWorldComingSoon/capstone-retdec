...
static int readImmediate(struct InternalInstruction* insn, uint8_t size)
{
	...
	insn->immediateOffset[insn->numImmediatesConsumed] =
	    (uint8_t)(insn->readerCursor - insn->startLocation);
	...
	switch (size) {
		case 1:
			...
			insn->immediateSizeRead[insn->numImmediatesConsumed] =
			    1;
			break;
		case 2:
